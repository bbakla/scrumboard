...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-md-11">
				<div class="panel panel-default">
					<div class="panel-heading" id="goalTitle" title="Backlogs">
						<a href="<c:url value='/projects/${project.id}/backlog'/>" class="btn btn-primary btn-lg btn-block">Add Backlog</a>
					</div>
					<div class="panel-body">
								...
								<tbody>
									<c:forEach items="${project.backlogs}" var="backlog">
										<tr>
											...
											<td>${project.id}</td>
											<td><a href="<c:url value='/projects/${backlog.id}'/>">${backlog.name}</a></td>
											<td><p title="Edit">
